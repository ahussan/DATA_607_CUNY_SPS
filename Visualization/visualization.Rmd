...
```{R load from github}
giturl = "https://raw.githubusercontent.com/ahussan/DATA_607_CUNY_SPS/master/Presentation/Big%20Mart.csv"
...
From our dataset, if we want to know the count of items on basis of their cost, then we can plot histogram using continuous variable Item_MRP as shown below.
